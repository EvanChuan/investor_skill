...
description: >
  產業研究與輪動策略，整合全球頂尖投行報告（JP Morgan、Goldman Sachs、BlackRock）與 13F 機構持倉，識別景氣循環中的產業機會，判斷供需關係、競爭格局與長期投資主題，可獨立執行或承接總體經濟分析後為個股選擇提供方向指引。

  當使用者詢問以下問題時請使用本 skill：現在該佈局哪些產業？半導體/AI/電動車/核電/國防產業處於什麼階段？產業輪動怎麼做？哪個環節利潤最高？投行現在推薦什麼產業？這個產業的供需健康嗎？有哪些結構性成長主題值得長期投資？什麼時候該從科技股輪動到金融股或防禦股？
version: 2.2.0
author: Evan
license: Proprietary
tags:
...
本模組專注於產業層面的深度研究,整合全球頂尖投行與研究機構的產業報告,搭配現有整體政策與經濟狀況,識別景氣循環中的產業機會,判斷產業競爭格局與長期趨勢,為個股選擇提供方向指引。
...
本模組整合全球頂尖投行與研究機構的集體智慧,動態追蹤最新市場共識。詳細機構追蹤方法請參考:
