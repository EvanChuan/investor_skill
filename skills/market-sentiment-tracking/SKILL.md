...
**詳細解讀：** 參考 `references/market-indicators/vix-interpretation-guide.md`
...
**詳細策略：** 參考 `references/market-indicators/fear-greed-reversal-strategy.md`
...
**詳細解讀：** 參考 `references/market-indicators/put-call-ratio-guide.md`
...
**詳細分析：** 參考 `references/institutional-flows/margin-trading-analysis.md`
...
**詳細分析：** 參考 `references/institutional-flows/institutional-flow-taiwan.md`
...
**詳細解讀：** 參考 `references/institutional-flows/institutional-ownership-analysis.md`
...
**詳細策略：** 參考 `references/institutional-flows/short-squeeze-detection.md`
...
**詳細解讀：** 參考 `references/options-analysis/gex-gamma-exposure-guide.md`
...
**詳細分析：** 參考 `references/market-indicators/gold-safe-haven-flow.md`
...
**詳細解讀：** 參考 `references/market-indicators/dxy-risk-sentiment.md`
...
**詳細分析：** 參考 `references/sentiment-analysis/analyst-consensus-tracking.md`
...
**詳細方法：** 參考 `references/sentiment-analysis/news-sentiment-nlp.md`
...
**詳細方法：** 參考 `references/sentiment-analysis/social-sentiment-analysis.md`
...
**詳細分析：** 參考 `references/sentiment-analysis/retail-investor-behavior.md`
...
**詳細方法：** 參考 `references/frameworks/sentiment-prediction-framework.md`
...
**評分細節：** 參考 `references/frameworks/sentiment-scoring-methodology.md`
...
**詳細策略：** 參考 `references/frameworks/contrarian-investing-framework.md`
...
**詳細報告範本：** 參考 `references/tools/sentiment-report-template.md`
...
- `references/market-indicators/vix-interpretation-guide.md` - VIX 恐慌指數完整解讀
- `references/market-indicators/fear-greed-reversal-strategy.md` - Fear \& Greed 極端點反轉策略
- `references/market-indicators/put-call-ratio-guide.md` - Put/Call Ratio 詳細解讀

**籌碼面分析：**

- `references/institutional-flows/margin-trading-analysis.md` - 融資融券分析方法（台股）
- `references/institutional-flows/institutional-flow-taiwan.md` - 法人買賣超分析（台股）
- `references/institutional-flows/institutional-ownership-analysis.md` - 機構持倉分析（美股）
- `references/institutional-flows/short-squeeze-detection.md` - 軋空機會識別
- `references/options-analysis/gex-gamma-exposure-guide.md` - GEX 與暴力盤分析

**資金流向：**

- `references/market-indicators/gold-safe-haven-flow.md` - 黃金避險資金流分析
- `references/market-indicators/dxy-risk-sentiment.md` - 美元指數風險情緒解讀

**分析師與社群：**

- `references/sentiment-analysis/analyst-consensus-tracking.md` - 分析師共識追蹤方法
- `references/sentiment-analysis/news-sentiment-nlp.md` - 新聞情緒 NLP 分析
- `references/sentiment-analysis/social-sentiment-analysis.md` - 社群媒體情緒挖掘

**散戶行為：**

- `references/sentiment-analysis/retail-investor-behavior.md` - 散戶行為監測指標

**情緒預測：**

- `references/frameworks/sentiment-prediction-framework.md` - 情緒預測與轉折點判斷
- `references/frameworks/sentiment-scoring-methodology.md` - 情緒評分計算方法

**逆向投資：**

- `references/frameworks/contrarian-investing-framework.md` - 逆向投資框架
- `references/frameworks/behavioral-finance-principles.md` - 行為金融學應用
...
- `references/tools/data-sources.md` - 完整數據來源與 API 指引

**實用工具：**

- `references/tools/sentiment-dashboard-template.md` - 情緒儀表板範本
- `references/tools/contrarian-opportunity-checklist.md` - 逆向機會檢查清單
- `references/tools/sentiment-report-template.md` - 完整報告範本
